...
export function Player() {
  ...
  const { episodeList, currentEpisodeIndex, isPlaying, isLooping, isShuffling, hasPrevious, hasNext, togglePlay, toggleLoop, toggleShuffle, setPlayingState, clearPlayerState, playNext, playPrevious } = usePlayer()
    ...
    <div className={styles.playerContainer}>
      ...
      { episode ? (
        ...
        <div className={styles.emptyPlayer}>
          <strong>Selelcione um podcast para ouvir</strong>
        </div>
      ) }
